...
/* sanford.lin add start on 20160308*/
#ifdef AEON_SUPPORT

#ifdef MTK_LENS_BU6424AF_SUPPORT
...
#ifdef MTK_LENS_BU6429AF_SUPPORT
...
#ifdef MTK_LENS_BU63165AF_SUPPORT
...
#ifdef MTK_LENS_DW9714AF_SUPPORT
...
#ifdef MTK_LENS_DW9761AF_SUPPORT
extern void DW9761AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9761AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int DW9761AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef MTK_LENS_DW9763AF_SUPPORT
...
#ifdef MTK_LENS_DW9814AF_SUPPORT
...
#ifdef MTK_LENS_DW9718AF_SUPPORT
...
#ifdef MTK_LENS_LC898122AF_SUPPORT
...
#ifdef MTK_LENS_LC898212AF_SUPPORT
...
#ifdef MTK_LENS_LC898212XDAF_SUPPORT
...
#ifdef MTK_LENS_AD5820AF_SUPPORT
